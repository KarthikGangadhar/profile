...
function d(h,k){var l=k&&typeof k;"object"==l||"function"==l?f.has(k)?l=f.get(k):(l=""+ ++g,f.set(k,l)):l="p_"+k;var n=h.g[l];if(n&&sa(h.g,l))for(var r=0;r<n.length;r++){var v=n[r];if(k!==k&&v.key!==v.key||k===v.key)return{id:l,list:n,index:r,u:v}}return{id:l,list:n,index:-1,u:void 0}}
...
function b(r){for(var v=g,p=0;64>p;p+=4)v[p/4]=r[p]<<24|r[p+1]<<16|r[p+2]<<8|r[p+3];for(p=16;80>p;p++)r=v[p-3]^v[p-8]^v[p-14]^v[p-16],v[p]=(r<<1|r>>>31)&4294967295;r=e[0];var C=e[1],J=e[2],qa=e[3],vc=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var La=qa^C&(J^qa);var Hb=1518500249}else La=C^J^qa,Hb=1859775393;else 60>p?(La=C&J|qa&(C|J),Hb=2400959708):(La=C^J^qa,Hb=3395469782);La=((r<<5|r>>>27)&4294967295)+La+vc+Hb+v[p]&4294967295;vc=qa;qa=J;J=(C<<30|C>>>2)&4294967295;C=r;r=La}e[0]=e[0]+r&4294967295;e[1]=
e[1]+C&4294967295;e[2]=e[2]+J&4294967295;e[3]=e[3]+qa&4294967295;e[4]=e[4]+vc&4294967295}
...
var Fc;
function Gc(){var a=u.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==Ab.indexOf("Presto")&&(a=function(){var e=document.createElement("IFRAME");e.style.display="none";Kb(e);document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(Fb(Ib));e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=A(function(k){if(("*"==h||k.origin==h)&&
...
ue=!1;
function ve(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=K(1,a),e=I(K(3,a));d&&e?(d=c,c=a.match(jc),d=d.match(jc),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?I(K(3,c))==e&&(Number(K(4,c))||null)==(Number(K(4,a))||null):!0;d=!!R("web_ajax_ignore_global_headers_if_set");for(var f in se)e=P(se[f]),!e||!c&&!we(a,f)||d&&void 0!==b[f]||(b[f]=e);if(c||we(a,"X-YouTube-Utc-Offset"))b["X-YouTube-Utc-Offset"]=-(new Date).getTimezoneOffset();(R("pass_biscotti_id_in_header_ajax")||R("pass_biscotti_id_in_header_ajax_tv"))&&(c||
we(a,"X-YouTube-Ad-Signals"))&&(b["X-YouTube-Ad-Signals"]=ge(ke(void 0)));return b}
function xe(a){var b=window.location.search,c=I(K(3,a)),d=I(K(5,a));d=(c=c&&c.endsWith("youtube.com"))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=he(b),f={};G(te,function(g){e[g]&&(f[g]=e[g])});
return je(a,f||{},!1)}
function we(a,b){var c=P("CORS_HEADER_WHITELIST")||{},d=I(K(3,a));return d?(c=c[d])?0<=Ka(c,b):!1:!0}
...
return b}
function He(a,b){b.method="POST";b.D||(b.D={});Be(a,b)}
...
'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))):e?Ce(a,b,"POST",e,d):P("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Ce(a,b,"GET","",d):Le(a,b)||Me(a,b))}
function Le(a,b){var c=Zd.EXPERIMENT_FLAGS;if(!c||!c.web_use_beacon_api_for_ad_click_server_pings)return!1;c=I(K(5,a));return c&&-1!=c.indexOf("/aclk")&&"1"===oc(a,"ae")&&"1"===oc(a,"act")?Ne(a)?(b&&b(),!0):!1:!1}
...
window.console.log(c.join("\n"),e)),e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=Wb(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&Ca(window.yterr)&&window.yterr(a),Oe[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Ya:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},D:{url:P("PAGE_NAME",window.location.href),
file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);e&&(b.D.stack=e);for(var g in f)b.D["client."+g]=f[g];if(g=P("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var h in g)b.D[h]=g[h];Be(P("ECATCHER_REPORT_HOST","")+"/error_204",b);Oe[a.message]=!0;Pe++}}
...
;var Xe=z("ytPubsubPubsubInstance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.M;N.prototype.publish=N.prototype.L;N.prototype.clear=N.prototype.clear;y("ytPubsubPubsubInstance",Xe,void 0);var Ye=z("ytPubsubPubsubSubscribedKeys")||{};y("ytPubsubPubsubSubscribedKeys",Ye,void 0);var Ze=z("ytPubsubPubsubTopicToKeys")||{};y("ytPubsubPubsubTopicToKeys",Ze,void 0);var $e=z("ytPubsubPubsubIsSynchronous")||{};y("ytPubsubPubsubIsSynchronous",$e,void 0);
...
function kf(a,b,c){c=void 0===c?null:c;var d=lf(a),e=document.getElementById(d),f=e&&Ve(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=af(d,b),b=""+(b[Ea]||(b[Ea]=++Fa)),mf[b]=f),g||(e=nf(a,d,function(){Ve(e,"loaded")||(Te(e),df(d),S(Ia(ef,d),0))},c)))}
...
function lf(a){var b=document.createElement("a");Jb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Nb(a)}
var mf={};function qf(){}
...
ya(tf);tf.getInstance();var vf=[],wf=!1;function xf(){if("1"!=Va(ae(),"args","privembed")){var a=function(){wf=!0;"google_ad_status"in window?O("DCLKSTAT",1):O("DCLKSTAT",2)};
...
Mf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Xa=z("ytEventsEventsListeners")||{};y("ytEventsEventsListeners",Xa,void 0);var Of=z("ytEventsEventsCounter")||{count:0};y("ytEventsEventsCounter",Of,void 0);
...
var Qf=Ta(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
g=ee(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Qf()||"boolean"==typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);Xa[e]=[a,b,c,g,d];return e}
function Rf(a){a&&("string"==typeof a&&(a=[a]),G(a,function(b){if(b in Xa){var c=Xa[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Qf()||"boolean"==typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete Xa[b]}}))}
;var Sf=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function Tf(a){this.A=a;this.f=null;this.j=0;this.o=null;this.l=0;this.h=[];for(a=0;4>a;a++)this.h.push(0);this.i=0;this.F=V(window,"mousemove",A(this.G,this));a=A(this.B,this);Ca(a)&&(a=ee(a));this.K=window.setInterval(a,25)}
D(Tf,L);Tf.prototype.G=function(a){w(a.f)||Nf(a);var b=a.f;w(a.g)||Nf(a);this.f=new Zb(b,a.g)};
Tf.prototype.B=function(){if(this.f){var a=Sf();if(0!=this.j){var b=this.o,c=this.f,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.j);this.h[this.i]=.5<Math.abs((d-this.l)/this.l)?1:0;for(c=b=0;4>c;c++)b+=this.h[c]||0;3<=b&&this.A();this.l=d}this.j=a;this.o=this.f;this.i=(this.i+1)%4}};
Tf.prototype.m=function(){window.clearInterval(this.K);Rf(this.F)};var Uf={};
function Vf(a){var b=void 0===a?{}:a;a=void 0===b.za?!0:b.za;b=void 0===b.Na?!1:b.Na;if(null==z("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?B()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&Wf();V(document,"keydown",Wf);V(document,"keyup",Wf);V(document,"mousedown",Wf);V(document,"mouseup",Wf);a&&(b?V(window,"touchmove",function(){Xf("touchmove",200)},{passive:!0}):(V(window,"resize",function(){Xf("resize",200)}),V(window,"scroll",function(){Xf("scroll",200)})));
...
y("ytLoggingTransportDispatchedStats_",ig,void 0);y("ytytLoggingTransportCapturedTime_",z("ytLoggingTransportCapturedTime_")||{},void 0);function jg(){T(fg);T(gg);gg=0;if(!Ya(W)){for(var a in W){var b=eg[a];b&&(kg(a,b),delete W[a])}Ya(W)||lg()}}
function lg(){R("web_gel_timeout_cap")&&!gg&&(gg=S(jg,6E4));T(fg);fg=S(jg,P("LOGGING_BATCH_TIMEOUT",oe("web_gel_debounce_ms",1E4)))}
function mg(a,b){b=void 0===b?"":b;W[a]=W[a]||{};W[a][b]=W[a][b]||[];return W[a][b]}
function kg(a,b){var c=bg[a],d=ig[a]||{};ig[a]=d;var e=Math.round(U());for(l in W[a]){var f=bb,g=b.f;g={client:{hl:g.Ga,gl:g.Fa,clientName:g.Da,clientVersion:g.Ea,configInfo:g.Ca}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(g.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=mg(a,l);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=hg[l])a:{var k=
...
function qg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:Yf())};R("log_sequence_info_on_gel_web")&&d.O&&(a=e.context,b=d.O,pg[b]=b in pg?pg[b]+1:0,a.sequence={index:pg[b],groupKey:b},d.pb&&delete pg[d.O]);(d=d.aa)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),hg[d.token]=a,d=mg("log_event",d.token)):d=mg("log_event");d.push(e);c&&(eg.log_event=new c);d.length>=(oe("web_logging_max_batch")||
100)?jg():lg()}
...
var tg=1;function ug(a,b,c){var d=vg;b={csn:a,parentVe:sg(b),childVes:Na(c,function(f){return sg(f)})};
c=q(c);for(var e=c.next();!e.done;e=c.next())e=sg(e.value),(Ya(e)||!e.trackingParams&&!e.veType)&&Qe(Error("Child VE logged with no data"),"WARNING");c={aa:void 0,O:a};"UNDEFINED_CSN"==a?wg("visualElementAttached",b,c):qg("visualElementAttached",b,d,c)}
function wg(a,b,c){a={sb:a,payload:b,options:c};(b=P("INTERACTIONS_LOGGER_QUEUE",void 0))?b.push(a):O("INTERACTIONS_LOGGER_QUEUE",[a])}
;function xg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.mb||P("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().lb:b=Bc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
...
;function zg(a,b,c,d){Vb.set(""+a,b,c,"/",void 0===d?"youtube.com":d,!1)}
;function Ag(){var a=new Pd;(a=a.isAvailable()?new Vd(a,"yt.innertube"):null)||(a=new Qd("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new Ld(a):null;this.g=document.domain||window.location.hostname}
Ag.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,B()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(hd(b))}catch(f){return}else e=escape(b);zg(a,e,c,this.g)};
Ag.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=Vb.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Ag.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;Vb.remove(""+a,"/",void 0===b?"youtube.com":b)};var Bg=new Ag;function Cg(a,b,c,d){if(d)return null;d=Bg.get("nextId",!0)||1;var e=Bg.get("requests",!0)||{};e[d]={method:a,request:b,authState:yg(c),requestTime:Math.round(U())};Bg.set("nextId",d+1,86400,!0);Bg.set("requests",e,86400,!0);return d}
function Dg(a){var b=Bg.get("requests",!0)||{};delete b[a];Bg.set("requests",b,86400,!0)}
function Eg(a){var b=Bg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=yg(xg(!1));$a(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),ng(a,d.method,e,{}));delete b[c]}}Bg.set("requests",b,86400,!0)}}
;function vg(a){var b=this;this.f=a||{Aa:$d("INNERTUBE_API_KEY"),Ba:$d("INNERTUBE_API_VERSION"),Ca:P("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Da:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),Ea:$d("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ga:$d("INNERTUBE_CONTEXT_HL"),Fa:$d("INNERTUBE_CONTEXT_GL"),Ha:$d("INNERTUBE_HOST_OVERRIDE")||"",Ia:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};sf(function(){Eg(b)},0,5E3)}
function ng(a,b,c,d){!P("VISITOR_DATA")&&.01>Math.random()&&Q(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",D:c,la:"JSON",N:function(){d.N()},
...
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Ha;g&&(f=g);g=a.f.Ia||!1;var h=xg(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=ie(""+f+("/youtubei/"+a.f.Ba+"/"+b),{alt:"json",key:a.f.Aa}),l;if(d.retry&&R("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Cg(b,c,h,g))){var n=e.onSuccess,r=e.ja;e.onSuccess=function(v,p){Dg(l);n(v,p)};
c.ja=function(v,p){Dg(l);r(v,p)}}try{R("use_fetch_for_op_xhr")?ye(k,e):He(k,e)}catch(v){if("InvalidAccessError"==v)l&&(Dg(l),l=0),Q(Error("An extension is blocking network request."),"WARNING");
else throw v;}l&&sf(function(){Eg(a)},0,5E3)}
;var Fg=B().toString();
...
return a.join("")}
;var Hg=z("ytLoggingTimeDocumentNonce_")||Gg();y("ytLoggingTimeDocumentNonce_",Hg,void 0);function Ig(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function Jg(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function Kg(a){return P(Jg(void 0===a?0:a),void 0)}
y("yt_logging_screen.getRootVeType",Kg,void 0);function Lg(){var a=Kg(0),b;a?b=new rg({veType:a,youtubeData:void 0}):b=null;return b}
function Mg(a){a=void 0===a?0:a;var b=P(Ig(a));b||0!=a||(R("kevlar_client_side_screens")?b="UNDEFINED_CSN":b=P("EVENT_ID"));return b?b:null}
y("yt_logging_screen.getCurrentCsn",Mg,void 0);function Ng(a,b,c){c=void 0===c?0:c;if(a!==P(Ig(c))||b!==P(Jg(c)))O(Ig(c),a),O(Jg(c),b),0==c&&(b=function(){setTimeout(function(){a&&qg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Hg,clientScreenNonce:a},vg)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
y("yt_logging_screen.setCurrentScreen",Ng,void 0);function Og(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=I(K(3,window.location.href));g&&f.push(g);g=I(K(3,d));if(0<=Ka(f,g)||!g&&0==d.lastIndexOf("/",0))if(R("autoescape_tempdata_url")&&(f=document.createElement("a"),Jb(f,d),d=f.href),d){g=d.match(jc);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&(b.itct||b.ved)&&
(b.csn=b.csn||Mg()),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e="ST-"+Nb(d).toString(36),b=b?lc(b):"",zg(e,b,k||5))}else k="ST-"+Nb(d).toString(36),b=b?lc(b):"",zg(k,b,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var r=void 0===r?window:r;c=r.location;a=mc(a,l)+n;a=a instanceof H?a:yb(a);c.href=wb(a)}return!0}
;function Pg(a){a=a||{};var b={enablejsapi:1},c={};this.url=a.url||"";this.args=a.args||ab(b);this.assets=a.assets||{};this.attrs=a.attrs||ab(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Pg.prototype.clone=function(){var a=new Pg,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==za(c)?a[b]=ab(c):a[b]=c}return a};function Qg(){L.call(this);this.f=[]}
t(Qg,L);Qg.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.nb)}L.prototype.m.call(this)};var Rg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Sg(a){a=a||"";if(window.spf){var b=a.match(Rg);spf.style.load(a,b?b[1]:"",void 0)}else Tg(a)}
function Tg(a){var b=Ug(a),c=document.getElementById(b),d=c&&Ve(c,"loaded");d||c&&!d||(c=Vg(a,b,function(){Ve(c,"loaded")||(Te(c),df(b),S(Ia(ef,b),0))}))}
...
function Ug(a){var b=document.createElement("A");a=zb(a);Jb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Nb(b)}
;function Wg(a,b){L.call(this);this.l=this.U=a;this.F=b;this.o=!1;this.api={};this.S=this.B=null;this.G=new N;Tc(this,Ia(Uc,this.G));this.i={};this.P=this.T=this.h=this.Z=this.f=null;this.K=!1;this.j=this.A=null;this.V={};this.qa=["onReady"];this.Y=null;this.ha=NaN;this.R={};Xg(this);this.W("WATCH_LATER_VIDEO_ADDED",this.Ka.bind(this));this.W("WATCH_LATER_VIDEO_REMOVED",this.La.bind(this));this.W("onAdAnnounce",this.sa.bind(this));this.ra=new Qg(this);Tc(this,Ia(Uc,this.ra))}
t(Wg,L);m=Wg.prototype;m.getId=function(){return this.F};
m.loadNewVideoConfig=function(a){if(!this.g){a instanceof Pg||(a=new Pg(a));this.Z=a;this.f=a.clone();this.h=this.f.attrs.id||this.h;"video-player"==this.h&&(this.h=this.F,this.f.attrs.id=this.F);this.l.id==this.h&&(this.h+="-player",this.f.attrs.id=this.h);this.f.args.enablejsapi="1";this.f.args.playerapiid=this.F;this.T||(this.T=Yg(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=uc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=
uc(Number(a)||a);Zg(this);this.o&&$g(this)}};
m.va=function(){return this.Z};
function $g(a){a.f.loaded||(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function ah(a){var b=!0,c=bh(a);c&&a.f&&(a=a.f,b=Ve(c,"version")==a.assets.js);return b&&!!z("yt.player.Application.create")}
function Zg(a){if(!a.g&&!a.K){var b=ah(a);if(b&&"html5"==(bh(a)?"html5":null))a.P="html5",a.o||ch(a);else if(dh(a),a.P="html5",b&&a.j)a.U.appendChild(a.j),ch(a);else{a.f.loaded=!0;var c=!1;a.A=function(){c=!0;var d=a.f.clone();z("yt.player.Application.create")(a.U,d);ch(a)};
a.K=!0;b?a.A():(jf(a.f.assets.js,a.A),Sg(a.f.assets.css),eh(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function bh(a){var b=ac(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function ch(a){if(!a.g){var b=bh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,b.isNotServable&&b.isNotServable(a.f.args.video_id)||fh(a)):a.ha=S(function(){ch(a)},50)}}
function fh(a){Xg(a);a.o=!0;var b=bh(a);b.addEventListener&&(a.B=gh(a,b,"addEventListener"));b.removeEventListener&&(a.S=gh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=gh(a,b,e))}for(var f in a.i)a.B(f,a.i[f]);$g(a);a.T&&a.T(a.api);a.G.L("onReady",a.api)}
function gh(a,b,c){var d=b[c];return function(){try{return a.Y=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.Y=e,fe(e))}}}
function Xg(a){a.o=!1;if(a.S)for(var b in a.i)a.S(b,a.i[b]);for(var c in a.R)T(parseInt(c,10));a.R={};a.B=null;a.S=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.W.bind(a);a.api.removeEventListener=a.Pa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.wa.bind(a);a.api.getPlayerType=a.xa.bind(a);a.api.getCurrentVideoConfig=a.va.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ja.bind(a)}
m.Ja=function(){return this.o};
m.W=function(a,b){var c=this,d=Yg(this,b);if(d){if(!(0<=Ka(this.qa,a)||this.i[a])){var e=hh(this,a);this.B&&this.B(a,e)}this.G.subscribe(a,d);"onReady"==a&&this.o&&S(function(){d(c.api)},0)}};
m.Pa=function(a,b){if(!this.g){var c=Yg(this,b);c&&Fd(this.G,a,c)}};
function Yg(a,b){var c=b;if("string"==typeof b){if(a.V[b])return a.V[b];c=function(){var d=z(b);d&&d.apply(u,arguments)};
a.V[b]=c}return c?c:null}
function hh(a,b){var c="ytPlayer"+b+a.F;a.i[b]=c;u[c]=function(d){var e=S(function(){if(!a.g){a.G.L(b,d);var f=a.R,g=String(e);g in f&&delete f[g]}},0);
Za(a.R,String(e))};
return c}
m.sa=function(a){df("a11y-announce",a)};
m.Ka=function(a){df("WATCH_LATER_VIDEO_ADDED",a)};
m.La=function(a){df("WATCH_LATER_VIDEO_REMOVED",a)};
m.xa=function(){return this.P||(bh(this)?"html5":null)};
m.wa=function(){return this.Y};
function dh(a){a.cancel();Xg(a);a.P=null;a.f&&(a.f.loaded=!1);var b=bh(a);b&&(ah(a)||!eh(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.U;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.A&&pf(this.f.assets.js,this.A);T(this.ha);this.K=!1};
m.m=function(){dh(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){Q(b)}this.V=null;for(var a in this.i)u[this.i[a]]=null;this.Z=this.f=this.api=null;delete this.U;delete this.l;L.prototype.m.call(this)};
function eh(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var ih={},jh="player_uid_"+(1E9*Math.random()>>>0);function kh(a){var b="player";b=x(b)?ac(b):b;var c=jh+"_"+(b[Ea]||(b[Ea]=++Fa)),d=ih[c];if(d)return d.loadNewVideoConfig(a),d.api;d=new Wg(b,c);ih[c]=d;df("player-added",d.api);Tc(d,Ia(lh,d));S(function(){d.loadNewVideoConfig(a)},0);
return d.api}
function lh(a){delete ih[a.getId()]}
;function mh(a,b,c){c=void 0===c?{}:c;var d=vg;P("ytLoggingEventsDefaultDisabled",!1)&&vg==vg&&(d=null);qg(a,b,d,c)}
;var nh=z("ytLoggingLatencyUsageStats_")||{};y("ytLoggingLatencyUsageStats_",nh,void 0);var oh=0;function ph(a){nh[a]=nh[a]||{count:0};var b=nh[a];b.count++;b.time=U();oh||(oh=sf(qh,0,5E3));if(5<b.count){if(6==b.count&&1>1E5*Math.random()){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;Qe(c,b)}return!0}return!1}
...
c=q(c);for(d=c.next();!d.done;d=c.next())th(a,d.value)}
...
xh.prototype.toString=function(){return this.topic};var yh=z("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.M;N.prototype.publish=N.prototype.L;N.prototype.clear=N.prototype.clear;y("ytPubsub2Pubsub2Instance",yh,void 0);y("ytPubsub2Pubsub2SubscribedKeys",z("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);y("ytPubsub2Pubsub2TopicToKeys",z("ytPubsub2Pubsub2TopicToKeys")||{},void 0);y("ytPubsub2Pubsub2IsAsync",z("ytPubsub2Pubsub2IsAsync")||{},void 0);
y("ytPubsub2Pubsub2SkipSubKey",null,void 0);function zh(a,b){var c=z("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
...
"playerInfo.preloadType",Y.yt_ad_pr="prerollAllowed",Y.pa="previousAction",Y.yt_red="isRedSubscriber",Y.st="serverTimeMs",Y.aq="tvInfo.appQuality",Y.br_trs="tvInfo.bedrockTriggerState",Y.label="tvInfo.label",Y.is_mdx="tvInfo.isMdx",Y.preloaded="tvInfo.isPreloaded",Y.query="unpluggedInfo.query",Y.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",Y.yt_vst="videoStreamType",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y),Ih="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),
Jh="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Kh={},Lh=(Kh.mver="MEASUREMENT_VERSION_",Kh.pis="PLAYER_INITIALIZED_STATE_",Kh.yt_pt="LATENCY_PLAYER_",Kh.pa="LATENCY_ACTION_",Kh.yt_vst="VIDEO_STREAM_TYPE_",Kh),Mh=!1;
function Nh(){Oh().info.yt_lt="hot_bg";if(Ph()){var a="hot_bg",b=Qh();(b.gelInfos?b.gelInfos:b).info_yt_lt=!0;if("yt_lt"in Hh){var c=Hh.yt_lt;0<=Ka(Jh,c)&&(a=!!a);"yt_lt"in Lh&&(a=Lh.yt_lt+a.toUpperCase());b={};c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];d[c[c.length-1]]=a;Ph()&&(a=Oh(),"gelInfo"in a||(a.gelInfo={}),rh(a.gelInfo,b),a=Rh(),c=Object.keys(b).join(""),ph("info_"+c+"_"+a)||(b.clientActionNonce=a,mh("latencyActionInfo",b)))}else 0<=Ka(Ih,"yt_lt")||(b=Error("Unknown label logged with GEL CSI"),
b.params="yt_lt",fe(b))}}
...
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function Rh(){var a=Oh().nonce;a||(a=Gg(),Oh().nonce=a);return a}
function Th(){return Oh().tick}
function Qh(){var a=Oh();"gel"in a||(a.gel={});return a.gel}
function Oh(){var a;(a=z("ytcsi.data_"))||(a={tick:{},info:{}},Ja("ytcsi.data_",a));return a}
function Uh(){var a=Th(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Oh().info.yt_pvis}
function Ph(){return!!R("csi_on_gel")||!!Oh().useGel}
function Vh(){Bh();if(!Ph()){var a=Th(),b=Oh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&Aa(a[f])){var d=f.slice(1);if(d in Gh){var e=Na(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=P("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:P("TIMING_ACTION",void 0)};d=Nh.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?b.h5jse=Math.round(b.h5jse-g.responseEnd):delete b.h5jse}a.aft=Sh();Uh()&&"youtube"==e&&(Nh(),e=a.vc,g=a.pbs,delete a.aft,b.aft=Math.round(g-e));for(var h in b)"_"!=h.charAt(0)&&(f[h]=b[h]);a.ps=Sf();h={};e=[];for(var k in a)"_"!=
k.charAt(0)&&(g=Math.round(a[k]-c),h[k]=g,e.push(k+"."+g));f.rt=e.join(",");(a=z("ytdebug.logTiming"))&&a(f,h);Wh(f,!!b.ap);zh(Fh,new Dh(h.aft+(d||0),void 0))}}
function Wh(a,b){if(R("debug_csi_data")){var c=z("yt.timing.csiData");c||(c=[],y("yt.timing.csiData",c,void 0));c.push({page:location.href,time:new Date,args:a})}c="";for(var d in a)c+="&"+d+"="+a[d];d="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var e=void 0===e?"":e;Ne(d,e)||Ke(d,void 0,void 0,void 0,e)}else Ke(d);Ja("yt.timing.pingSent_",!0)}
;function Xh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function Yh(a,b,c){x(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Zh(a)}
function Zh(a,b,c){if(Da(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function $h(a,b,c,d){if(Da(a)&&!Aa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};x(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function ai(a){L.call(this);this.f=a;this.f.subscribe("command",this.ma,this);this.h={};this.j=!1}
D(ai,L);m=ai.prototype;m.start=function(){this.j||this.g||(this.j=!0,bi(this.f,"RECEIVING"))};
m.ma=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":x(d.event)&&(a=d.event,a in this.h||(c=A(this.Ra,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":x(d.event)&&ci(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=di(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=ei(a,c))&&this.j&&!this.g&&bi(this.f,a,c))}}};
m.Ra=function(a,b){this.j&&!this.g&&bi(this.f,a,this.ca(a,b))};
m.ca=function(a,b){if(null!=b)return{value:b}};
function ci(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
m.m=function(){var a=this.f;a.g||Fd(a.f,"command",this.ma,this);this.f=null;for(var b in this.h)ci(this,b);ai.C.m.call(this)};function fi(a,b){ai.call(this,b);this.i=a;this.start()}
D(fi,ai);fi.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
...
fi.prototype.ca=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return fi.C.ca.call(this,a,b)};
fi.prototype.m=function(){fi.C.m.call(this);delete this.i};function gi(a,b,c){L.call(this);var d=this;c=c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.A="*";this.i=c;this.sessionId=null;this.channel="widget";this.B=!!a;this.o=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h)&&x(e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.B&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
e.origin&&(d.i=d.A=e.origin);d.h=e.source;d.sessionId=f.id;d.f&&(d.f(),d.f=null);break;case "command":d.j&&(!d.l||0<=Ka(d.l,f.func))&&d.j(f.func,f.args,e.origin)}}};
this.l=this.f=this.j=null;window.addEventListener("message",this.o)}
t(gi,L);gi.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.A)}catch(e){Q(e,"WARNING")}}};
gi.prototype.m=function(){window.removeEventListener("message",this.o);L.prototype.m.call(this)};function hi(){var a=this.g=new gi(!!P("WIDGET_ID_ENFORCE")),b=A(this.Oa,this);a.j=b;a.l=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
m=hi.prototype;m.Oa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,ii(this,a)),this.j[a]=!0)):this.oa(a,b,c)};
m.oa=function(){};
...
m.dispose=function(){this.g=null};function ki(a){hi.call(this);this.f=a;this.h=[];this.addEventListener("onReady",A(this.Ma,this));this.addEventListener("onVideoProgress",A(this.Va,this));this.addEventListener("onVolumeChange",A(this.Wa,this));this.addEventListener("onApiChange",A(this.Qa,this));this.addEventListener("onPlaybackQualityChange",A(this.Sa,this));this.addEventListener("onPlaybackRateChange",A(this.Ta,this));this.addEventListener("onStateChange",A(this.Ua,this));this.addEventListener("onWebglSettingsChanged",A(this.Xa,
this))}
D(ki,hi);m=ki.prototype;m.oa=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Xh(a)){var d=b;if(Da(d[0])&&!Aa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Zh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Yh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=$h.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Xh(a)&&ji(this,this.da())}};
...
m.Sa=function(a){ji(this,{playbackQuality:a})};
m.Ta=function(a){ji(this,{playbackRate:a})};
...
m.Wa=function(){ji(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
m.Va=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:B()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());ji(this,a)};
m.Xa=function(){var a={sphericalProperties:this.f.getSphericalProperties()};ji(this,a)};
m.dispose=function(){ki.C.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function li(a){a=void 0===a?!1:a;L.call(this);this.f=new N(a);Tc(this,Ia(Uc,this.f))}
D(li,L);li.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
...
D(mi,li);function bi(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(hd(a),d.i))}}
mi.prototype.m=function(){this.i=this.h=null;mi.C.m.call(this)};function ni(a,b,c){L.call(this);this.f=a;this.i=c;this.j=V(window,"message",A(this.l,this));this.h=new mi(this,a,b);Tc(this,Ia(Uc,this.h))}
D(ni,L);ni.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,x(b))){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
ni.prototype.m=function(){Rf(this.j);this.f=null;ni.C.m.call(this)};function oi(){var a=ab(pi),b;return ud(new M(function(c,d){a.onSuccess=function(e){re(e)?c(e):d(new qi("Request failed, status="+e.status,"net.badstatus",e))};
...
return sd(c)})}
function qi(a,b){F.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
t(qi,F);function ri(){this.g=0;this.f=null}
ri.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),nd(a)?a:si(a)):2===this.g&&b?(a=b.call(c,this.f),nd(a)?a:ti(a)):this};
...
;function ui(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof vi;this.isTimeout=a instanceof qi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof vd}
t(ui,F);ui.prototype.name="BiscottiError";function vi(){F.call(this,"Biscotti ID is missing from server")}
t(vi,F);vi.prototype.name="BiscottiMissingError";var pi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},wi=null;function ce(){if("1"===Va(ae(),"args","privembed"))return sd(Error("Biscotti ID is not available in private embed mode"));wi||(wi=ud(oi().then(xi),function(a){return yi(2,a)}));
return wi}
function xi(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new vi;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new vi;a=a.id;de(a);wi=si(a);zi(18E5,2);return a}
function yi(a,b){var c=new ui(b);de("");wi=ti(c);0<a&&zi(12E4,a-1);throw c;}
function zi(a,b){S(function(){ud(oi().then(xi,function(c){return yi(b,c)}),xa)},a)}
function Ai(){try{var a=z("yt.ads.biscotti.getId_");return a?a():ce()}catch(b){return sd(b)}}
;function Bi(a){if("1"!==Va(ae(),"args","privembed")){a&&be();try{Ai().then(function(b){R("pass_biscotti_id_in_header_ajax_tv")||R("pass_biscotti_id_in_header_ajax")||(b=ke(b),b.bsq=Ci++,He("//www.youtube.com/ad_data_204",{ya:!1,D:b,withCredentials:!0}))},function(){}),S(Bi,18E5)}catch(b){Q(b)}}}
var Ci=0;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Di(){this.f=P("ALT_PREF_COOKIE_NAME","PREF");var a=Vb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
m.save=function(){zg(this.f,this.dump(),63072E3)};
...
ya(Di);var Hi=null,Ii=null,Ji=null,Ki={};function Li(a){var b=a.id;a=a.ve_type;var c=tg++;a=new rg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Ki[b]=a;b=Mg();c=Lg();b&&c&&ug(b,c,[a])}
function Mi(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Ng(b,a),a=Lg()))for(var c in Ki){var d=Ki[c];d&&ug(b,a,[d])}}
function Ni(a){Ki[a.id]=new rg({trackingParams:a.tracking_params})}
function Oi(a){var b=Mg(),c=Ki[a.id];if(b&&c){a=vg;c={csn:b,ve:sg(c),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var d={aa:void 0,O:b};"UNDEFINED_CSN"==b?wg("visualElementGestured",c,d):qg("visualElementGestured",c,a,d)}}
function Pi(a){a=a.ids;var b=Mg();if(b)for(var c=0;c<a.length;c++){var d=Ki[a[c]];if(d){var e=vg;d={csn:b,ve:sg(d),eventType:1};var f={aa:void 0,O:b};"UNDEFINED_CSN"==b?wg("visualElementShown",d,f):qg("visualElementShown",d,e,f)}}}
...
y("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);Bi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");Hi=a=kh(a);a.addEventListener("onScreenChanged",Mi);a.addEventListener("onLogClientVeCreated",Li);a.addEventListener("onLogServerVeCreated",Ni);a.addEventListener("onLogVeClicked",Oi);a.addEventListener("onLogVesShown",
Pi);b=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?Ji=new ki(a):P("ENABLE_POST_API")&&x(b)&&x(c)&&(Ii=new ni(window.parent,b,c),Ji=new fi(a,Ii.h));c=$d("BG_P");Hf(c)&&(P("BG_I")||P("BG_IU"))&&(Df=!0,Cf.initialize(P("BG_I",null),P("BG_IU",null),c,Gf,void 0));xf()},void 0);
y("yt.www.watch.ads.restrictioncookie.spr",function(a){Ke(a+"mac_204?action_fcts=1");return!0},void 0);
var Qi=ee(function(){var a="ol";X.mark&&(0==a.lastIndexOf("mark_",0)||(a="mark_"+a),X.mark(a));a=Th();var b=Sf();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=Ah();if(b=a.ol)uf(b),a.ol=0;a=Qh();(a.gelTicks?a.gelTicks:a).tick_ol=!0;Sf();Ph()?(a=Rh(),ph("tick_ol_"+a)||mh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(a=!a)a=!z("yt.timing.pingSent_");if(a&&(b=P("TIMING_ACTION",void 0),a=Th(),z("ytglobal.timingready_")&&b&&a._start&&(b=Sh()))){Mh||(zh(Eh,
new Ch(Math.round(b-a._start),void 0)),Mh=!0);b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Vh()}a=Di.getInstance();c=!!((Gi("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Xc(document.body,"exp-invert-logo")&&(b&&!Xc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Xc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")):!b&&
Xc(document.body,"inverted-hdpi")&&Yc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=Gi(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),Ri=ee(function(){var a=Hi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Cf.dispose();a=0;for(var b=vf.length;a<b;a++)uf(vf[a]);vf.length=0;of("//static.doubleclick.net/instream/ad_status.js");wf=!1;O("DCLKSTAT",0);Vc(Ji,Ii);if(a=Hi)a.removeEventListener("onScreenChanged",Mi),a.removeEventListener("onLogClientVeCreated",Li),a.removeEventListener("onLogServerVeCreated",Ni),a.removeEventListener("onLogVeClicked",Oi),a.removeEventListener("onLogVesShown",Pi),a.destroy();Ki={}});
window.addEventListener?(window.addEventListener("load",Qi),window.addEventListener("unload",Ri)):window.attachEvent&&(window.attachEvent("onload",Qi),window.attachEvent("onunload",Ri));Ja("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||If);Ja("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||Jf);Ja("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||yf);
Ja("yt.player.exports.navigate",z("yt.player.exports.navigate")||Og);Ja("yt.util.activity.init",z("yt.util.activity.init")||Vf);Ja("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||Yf);Ja("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||Wf);}).call(this);
